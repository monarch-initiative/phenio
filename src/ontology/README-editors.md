These notes are for the EDITORS of phenio
...
Make sure you have an ID range in the [idranges file](phenio-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [phenio-edit.owl](phenio-edit.owl)

** DO NOT EDIT phenio.obo OR phenio.owl in the top level directory **

[../../phenio.owl](../../phenio.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/monarch-initiative/phenio) for details.
 ...
 * [phenio-idranges.owl](phenio-idranges.owl)
...
This generates derived files such as phenio.owl and phenio.obo and places
 ...
 * https://github.com/monarch-initiative/phenio/releases/new
...
what is in the `owl:versionIRI` of the derived phenio.owl (`data-version` in
phenio.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/phenio.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/phenio/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/monarch-initiative/phenio.svg?branch=master)](https://travis-ci.org/monarch-initiative/phenio)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/monarch-initiative](https://travis-ci.org/profile/monarch-initiative)
 2. click the "Sync account" button
 3. Click the tick symbol next to phenio
