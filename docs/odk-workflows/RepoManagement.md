...
1. Add an imports statement to your `src/ontology/phenio-edit.owl` file. We suggest to do this using a text editor, by simply copying an existing imports declaration and renaming it to the new ontology import, for example as follows:
