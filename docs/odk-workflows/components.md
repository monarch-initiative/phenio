...
```
  <uri name="http://purl.obolibrary.org/obo/phenio/components/your-component-name.owl" uri="components/your-component-name.owl"/>
```

4) Add the component to the edit file (src/ontology/phenio-edit.obo)
for .obo formats: 

```
import: http://purl.obolibrary.org/obo/phenio/components/your-component-name.owl
```
...
6) In your custom makefile (src/ontology/phenio.Makefile) add a goal for your custom make file. In this example, the goal is a ROBOT template.
